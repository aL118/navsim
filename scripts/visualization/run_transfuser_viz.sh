...
# SLURM script to generate simulator footage visualizations

#SBATCH --job-name=viz_transfuser
...
EXPERIMENT="10fps_visualizations"
...
# Usage:
# sbatch scripts/visualization/run_transfuser_viz.sh
